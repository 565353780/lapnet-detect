...
int main()
{
    NetType net_type = LapNet;
    int net_input_width = 1024;
    int net_input_height = 512;
    string model_path = "/home/abaci/ABACI/LapNet_Detect/model/LapNet_Edge_Detect.pt";
    string image_path = "/home/abaci/ABACI/LapNet_Detect/data/test/984.jpg";
    string video_path = "/home/abaci/ABACI/LapNet_Detect/data/test/NVR_ch2_main_20201111164000_20201111170000.avi";
    bool show_result = false;
    int screen_width = 1920;
    int screen_height = 1080;
    bool save_result = false;
    string save_path = "/home/abaci/ABACI/LapNet_Detect/data/test/output";
    MsgLevel msg_level = Info;

    DataProcesser data_processer;

    bool load_model_success = data_processer.init(net_type,
                                                  net_input_width,
                                                  net_input_height,
                                                  model_path,
                                                  msg_level,
