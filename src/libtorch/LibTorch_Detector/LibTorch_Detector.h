...
public:
    ...
    string get_net_type_string(NetType net_type)
    {
        return net_type_vec_[int(net_type)];
    }
    string get_current_net_type_string()
    {
        return get_net_type_string(net_type_);
    }
